...
function createServer() {
  ...
  s.tool("create_custom_field_v2", "Create a custom field (v2).", { locationId: z.string(), name: z.string(), dataType: z.string(), objectKey: z.string().optional() }, async (args) => ({ content: [{ type: "text", text: JSON.stringify(await createCustomFieldV2(args), null, 2) }] }));
  ...
  s.tool("create_object_record", "Create a record in a custom object.", { locationId: z.string(), schemaId: z.string(), properties: z.record(z.any()).optional() }, async (args) => ({ content: [{ type: "text", text: JSON.stringify(await createObjectRecord(args), null, 2) }] }));
  ...
  s.tool("update_object_record", "Update a custom object record.", { locationId: z.string(), schemaId: z.string(), recordId: z.string(), properties: z.record(z.any()).optional() }, async (args) => ({ content: [{ type: "text", text: JSON.stringify(await updateObjectRecord(args), null, 2) }] }));
