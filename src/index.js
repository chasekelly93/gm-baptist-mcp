...
function createServer() {
  ...
  s.tool("create_custom_field_v2", "Create a custom field (v2). fieldKey must follow pattern contact.{snake_case_name}.", { locationId: z.string(), name: z.string().optional(), dataType: z.enum(["TEXT", "LARGE_TEXT", "NUMERICAL", "PHONE", "MONETARY", "CHECKBOX", "MULTIPLE_OPTIONS", "SINGLE_OPTIONS", "DATE", "TEXTBOX_LIST", "FILE_UPLOAD", "SIGNATURE"]), fieldKey: z.string(), objectKey: z.string(), parentId: z.string().optional(), placeholder: z.string().optional(), isRequired: z.boolean().optional(), options: z.array(z.string()).optional() }, async (args) => ({ content: [{ type: "text", text: JSON.stringify(await createCustomFieldV2(args), null, 2) }] }));
